...
# Nawar banner used at the top of every transactional email.
BANNER_URL = "https://d1yei2z3i6k35z.cloudfront.net/9533860/68b2e90e8ca75_Holand%C3%A9sconNawar.png"
BANNER_HTML = (
    f'<img src="{BANNER_URL}" alt="Holandés Nawar" width="260" '
...
<head>
    ...
    <style>
        /* Dark-mode override: invert the brand button so it stays readable
           when the client renders the message in dark mode. */
        @media (prefers-color-scheme: dark) {{
            .brand-btn {{
                background-color: #0a1656 !important;
