...
El fin de semana el reloj es menos estricto. El sábado la gente hace la compra y hace deporte. El domingo ven a su familia. ¿Y en verano? Todo Países Bajos se sienta fuera, porque el sol aquí es una fiesta.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l5e-47', type: 'fill_blank', prompt: 'Ik werk ___ maandag ___ 8 uur. (dos preposiciones, separadas por espacio)', correctAnswer: 'op om', hint: 'día, luego hora' },
        { id: 'm2l5e-48', type: 'fill_blank', prompt: 'Ik studeer ___ de ochtend ___ 9 uur. (dos preposiciones, separadas por espacio)', correctAnswer: 'in om', hint: 'momento del día, luego hora' },
