...
Café o té: 1 euro`,
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm1l1e-27', type: 'write_answer', prompt: 'Escribe en neerlandés: "Me llamo Ana"', correctAnswer: 'Ik heet Ana', hint: 'Empieza con "Ik…"' },
        { id: 'm1l1e-28', type: 'write_answer', prompt: 'Escribe en neerlandés: "Vivo en Amsterdam"', correctAnswer: 'Ik woon in Amsterdam', hint: 'wonen → ik woon' },
        // ── Escuchar ──
        ...
        // ── Escuchar y traducir (frases de la lección) ──
...
Sofía y Pablo`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l2e-25', type: 'write_answer', prompt: 'Escribe en neerlandés: "Ella es médica" (forma fuerte)', correctAnswer: 'Zij is arts', hint: 'Empieza con la forma fuerte' },
        // ── Escuchar ──
...
Mucha gente en Países Bajos no trabaja cinco días, sino cuatro. En otros países eso lo hace poca gente. Países Bajos es el número uno de Europa.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l3e-26', type: 'write_answer', prompt: 'Escribe en neerlandés: "Él aprende en casa"', correctAnswer: 'Hij leert thuis', hint: 'raíz + t' },
        // ── Escuchar ──
...
¿Y el agua? El agua del grifo es casi gratis. Cien litros cuestan unos quince céntimos.`,
      exercises: [
        ...
        { id: 'm1l4lz-8', type: 'multiple_choice', prompt: 'Wat kosten twee kopjes koffie?', options: ['Acht euro', 'Vier euro', 'Zes euro', 'Tien euro'], correctAnswer: 'Acht euro', explanation: 'Vier plus vier is acht: dos cafés de cuatro euros.' },
        ...
        { id: 'm1l4lz-11', type: 'multiple_choice', prompt: '¿Qué es más caro: un pan (een brood) del supermercado o un litro de leche?', options: ['El pan', 'La leche', 'Cuestan lo mismo', 'No lo dice'], correctAnswer: 'El pan', explanation: 'Pan 2,10 €; leche 1,15 €.' },
...
En una dirección de correo está el signo @. En neerlandés ese signo se llama apenstaartje (rabito de mono).`,
      exercises: [
        ...
        { id: 'm1l5lz-3', type: 'multiple_choice', prompt: 'Hoeveel letters heeft de achternaam Oldenbarnevelt?', options: ['Veertien', 'Twaalf', 'Achttien', 'Twintig'], correctAnswer: 'Veertien', explanation: '"Oldenbarnevelt heeft veertien letters."' },
        ...
        { id: 'm1l5lz-5', type: 'multiple_choice', prompt: 'Met welke letter eindigt Rembrandt?', options: ['Met een t', 'Met een d', 'Met een k', 'Met een n'], correctAnswer: 'Met een t', explanation: '"Rembrandt eindigt op een t." Es la pregunta clásica al teléfono.' },
        { id: 'm1l5lz-6', type: 'multiple_choice', prompt: 'En Van Dijk?', options: ['Met een k', 'Met een t', 'Met een d', 'Met een j'], correctAnswer: 'Met een k', explanation: '"Van Dijk eindigt op een k."' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1d5q-2', type: 'multiple_choice', prompt: 'Met welke letter eindigt Martínez?', options: ['Met een z', 'Met een s', 'Met een t', 'Met een d'], correctAnswer: 'Met een z', explanation: '"Met een z aan het eind".' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l5e-33', type: 'listen_translate', prompt: 'Escucha y traduce: "Mijn achternaam begint met een Z"', options: ['Mi', 'apellido', 'empieza', 'con', 'Z', 'termina', 'nombre', 'una'], correctAnswer: 'Mi apellido empieza con Z', alsoAccept: ['Mi apellido empieza con una Z'] },
...
Junto al mar sopla el viento casi todos los días. Por eso en Países Bajos hay muchos molinos.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l6e-25', type: 'write_answer', prompt: 'Escribe en neerlandés: "El sol brilla"', correctAnswer: 'De zon schijnt', hint: 'schijnen = brillar' },
        // ── Escuchar ──
  ...
  blocks: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Esto es lo único de gramática que tiene la lección, y es en lo que más se falla. La regla corta: **el color lleva -e cuando va delante de la cosa** (*de rode auto*, *het rode huis*, *zwarte kleren*) **y no la lleva cuando va detrás del verbo** (*de auto is rood*). Una sola excepción: **een + palabra de het**, sin -e: *een rood huis*. Si dudas, dos preguntas: ¿va delante? → -e. ¿Es *een* con una palabra de *het*? → sin -e.',
          items: [
...
El abuelo y la abuela no siempre viven en la misma ciudad. Mucha gente visita a sus padres cada semana. Otros ven a su familia solo en las fiestas.`,
      exercises: [
        ...
        { id: 'm2l1lz-3', type: 'multiple_choice', prompt: '¿Cuántos hijos suele tener un "gezin met kinderen"?', options: ['Uno o dos', 'Cinco o seis', 'Tres o cuatro', 'No lo dice'], correctAnswer: 'Uno o dos', explanation: '"meestal één of twee kinderen".' },
        ...
        { id: 'm2l1lz-7', type: 'true_false', prompt: 'Los abuelos casi siempre viven en la misma ciudad que sus hijos.', correctAnswer: 'falso', explanation: '"De opa en de oma wonen niet altijd in dezelfde stad": el texto dice que NO siempre, y no dice nada de casi siempre.' },
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm2l1e-26', type: 'write_answer', prompt: 'Escribe en neerlandés: "Esta es mi madre"', correctAnswer: 'Dit is mijn moeder', hint: 'Empieza con "Dit…"' },
        { id: 'm2l1e-27', type: 'write_answer', prompt: 'Escribe en neerlandés: "Estos son mis padres"', correctAnswer: 'Dit zijn mijn ouders', hint: 'Varias personas' },
        // ── Escuchar ──
        ...
        // ── Del pack de ejercicios del profe (Familie en relaties, parte 1) ──
        { id: 'm2l1e-39', type: 'match_pairs', prompt: 'Une cada palabra con su traducción', correctAnswer: '', pairs: [
          { left: 'de opa', right: 'el abuelo' },
          { left: 'de oma', right: 'la abuela' },
          { left: 'het kind', right: 'el niño' },
          { left: 'de kinderen', right: 'los niños' },
          { left: 'de partner', right: 'la pareja' },
          { left: 'het gezin', right: 'la familia (con la que vives)' },
        ] },
        { id: 'm2l1e-40', type: 'fill_blank', prompt: 'Dit is mijn ___. (moeder / ouders)', correctAnswer: 'moeder', hint: '"Dit is" es singular', explanation: 'Dit is + una persona; dit zijn + varias.' },
        { id: 'm2l1e-41', type: 'fill_blank', prompt: 'Dit ___ mijn ouders. (is / zijn)', correctAnswer: 'zijn', hint: 'ouders es plural', explanation: 'Con plural: dit zijn.' },
        { id: 'm2l1e-42', type: 'multiple_choice', prompt: 'Zij is mijn ___', options: ['vriendin', 'vriend', 'ouders', 'broer'], correctAnswer: 'vriendin', explanation: 'Zij = ella → vriendin (con -in).' },
        { id: 'm2l1e-43', type: 'order_sentence', prompt: 'Ordena: "Esta es mi madre"', options: ['Dit', 'is', 'mijn', 'moeder'], correctAnswer: 'Dit is mijn moeder' },
        { id: 'm2l1e-44', type: 'order_sentence', prompt: 'Ordena: "Él es mi amigo"', options: ['Hij', 'is', 'mijn', 'vriend'], correctAnswer: 'Hij is mijn vriend' },
        { id: 'm2l1e-45', type: 'multiple_choice', prompt: '¿Cuál está bien?', options: ['Dit zijn mijn ouders', 'Dit is mijn ouders', 'Dit zijn mijn moeder', 'Dit is mijn ouder'], correctAnswer: 'Dit zijn mijn ouders', explanation: 'Ouders es plural → zijn.' },
        { id: 'm2l1e-46', type: 'multiple_choice', prompt: 'Corrige: "Hij is mijn vriendin"', options: ['Hij is mijn vriend', 'Zij is mijn vriend', 'Hij is mijn vriendinnen', 'Está bien así'], correctAnswer: 'Hij is mijn vriend', explanation: 'Hij (él) → vriend; zij (ella) → vriendin.' },
        { id: 'm2l1e-47', type: 'fill_blank', prompt: 'Het ___ = la familia con la que vives (padres e hijos)', correctAnswer: 'gezin', hint: 'palabra de "het"', explanation: 'Gezin = el núcleo; familie = toda la familia, primos incluidos.' },
        { id: 'm2l1e-48', type: 'multiple_choice', prompt: '¿Qué diferencia hay entre "het gezin" y "de familie"?', options: ['Gezin es la familia con la que vives; familie es toda la familia', 'Son sinónimos exactos', 'Gezin son solo los padres', 'Familie son solo los primos'], correctAnswer: 'Gezin es la familia con la que vives; familie es toda la familia', explanation: 'Un gezin son padres e hijos en la misma casa. La familie incluye a abuelos, tíos y primos.' },
      ],
    },
    { type: 'review' },
  ],
...
Casi todo el mundo tiene una bici. En Países Bajos hay más bicis que personas: unos veintitrés millones.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm2l2e-28', type: 'write_answer', prompt: 'Escribe en neerlandés: "Mi hermana vive en Madrid"', correctAnswer: 'Mijn zus woont in Madrid', hint: 'S + V(2º) + resto' },
        ...
        // ── Del pack de ejercicios del profe (parte 2: la frase-tren con la familia) ──
        { id: 'm2l2e-40', type: 'order_sentence', prompt: 'Ordena: "Mi hermano vive en Utrecht"', options: ['Mijn broer', 'woont', 'in Utrecht'], correctAnswer: 'Mijn broer woont in Utrecht' },
        { id: 'm2l2e-41', type: 'order_sentence', prompt: 'Ordena: "Mis padres trabajan en Países Bajos"', options: ['Mijn ouders', 'werken', 'in Nederland'], correctAnswer: 'Mijn ouders werken in Nederland' },
        { id: 'm2l2e-42', type: 'order_sentence', prompt: 'Ordena: "Mi amigo estudia en Ámsterdam"', options: ['Mijn vriend', 'studeert', 'in Amsterdam'], correctAnswer: 'Mijn vriend studeert in Amsterdam' },
        { id: 'm2l2e-43', type: 'multiple_choice', prompt: 'Mijn ouders ___ in Nederland.', options: ['werken', 'werkt', 'werk', 'werkte'], correctAnswer: 'werken', explanation: 'Ouders = plural → verbo entero.' },
        { id: 'm2l2e-44', type: 'fill_blank', prompt: 'Mijn broer ___ (wonen) in Utrecht.', correctAnswer: 'woont', hint: 'raíz + t' },
        { id: 'm2l2e-45', type: 'fill_blank', prompt: 'Jij ___ (wonen) in Spanje.', correctAnswer: 'woont', hint: 'jij también lleva -t' },
        { id: 'm2l2e-46', type: 'fill_blank', prompt: 'Wij ___ (werken) in Nederland.', correctAnswer: 'werken', hint: 'plural → verbo entero' },
        { id: 'm2l2e-47', type: 'multiple_choice', prompt: 'Corrige: "Mijn moeder Spanje woont"', options: ['Mijn moeder woont in Spanje', 'Mijn moeder in Spanje woont', 'Woont mijn moeder Spanje', 'Spanje woont mijn moeder'], correctAnswer: 'Mijn moeder woont in Spanje', explanation: 'Sujeto, verbo en el lugar dos, y luego el resto. Y "in" delante del país.' },
        { id: 'm2l2e-48', type: 'multiple_choice', prompt: 'Corrige: "Mijn vriend Amsterdam studeert"', options: ['Mijn vriend studeert in Amsterdam', 'Mijn vriend in Amsterdam studeert', 'Studeert mijn vriend Amsterdam', 'Está bien así'], correctAnswer: 'Mijn vriend studeert in Amsterdam', explanation: 'El verbo no puede irse al final en una frase normal.' },
        { id: 'm2l2e-49', type: 'write_answer', prompt: 'De lista a frase: "mijn broer – Utrecht – studeren"', correctAnswer: 'Mijn broer studeert in Utrecht', hint: 'Sujeto + verbo + in + ciudad' },
        { id: 'm2l2e-50', type: 'write_answer', prompt: 'De lista a frase: "mijn ouders – Nederland – werken"', correctAnswer: 'Mijn ouders werken in Nederland', hint: 'plural → verbo entero' },
      ],
    },
    { type: 'review' },
  ],
...
Los neerlandeses planifican pronto sus vacaciones. En enero mucha gente ya reserva las vacaciones de verano.`,
      exercises: [
        ...
        { id: 'm2l3lz-2', type: 'multiple_choice', prompt: '¿Qué días trabaja la mayoría?', options: ['Van maandag tot vrijdag', 'Van maandag tot zaterdag', 'Alleen doordeweeks in de middag', 'Elke dag'], correctAnswer: 'Van maandag tot vrijdag', explanation: '"Van maandag tot vrijdag werken de meeste mensen."' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2d3q-3', type: 'multiple_choice', prompt: '¿Cuántos años cumple la abuela?', options: ['tachtig', 'zeventig', 'negentig', 'vijfenzeventig'], correctAnswer: 'tachtig', explanation: '"Tachtig!" = ochenta.' },
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm2l3e-26', type: 'write_answer', prompt: 'Escribe en neerlandés: "Trabajo hoy"', correctAnswer: 'Ik werk vandaag', hint: 'S + V + tiempo' },
        ...
        // ── Del pack de ejercicios del profe (parte 3: días, momentos y tiempo en la frase) ──
        { id: 'm2l3e-38', type: 'match_pairs', prompt: 'Une cada palabra de tiempo con su traducción', correctAnswer: '', pairs: [
          { left: 'gisteren', right: 'ayer' },
          { left: 'vandaag', right: 'hoy' },
          { left: 'morgen', right: 'mañana' },
          { left: 'volgende week', right: 'la semana que viene' },
          { left: '’s ochtends', right: 'por la mañana' },
          { left: '’s middags', right: 'por la tarde' },
        ] },
        { id: 'm2l3e-39', type: 'fill_blank', prompt: 'Ik ___ (bezoeken) mijn oma morgen.', correctAnswer: 'bezoek', hint: 'con ik, la raíz sola' },
        { id: 'm2l3e-40', type: 'fill_blank', prompt: 'Wij ___ (zien) onze familie dit weekend.', correctAnswer: 'zien', hint: 'wij → verbo entero' },
        { id: 'm2l3e-41', type: 'order_sentence', prompt: 'Ordena: "Visito a mi abuela mañana"', options: ['Ik', 'bezoek', 'mijn oma', 'morgen'], correctAnswer: 'Ik bezoek mijn oma morgen' },
        { id: 'm2l3e-42', type: 'order_sentence', prompt: 'Ordena: "Mi madre trabaja mañana"', options: ['Mijn moeder', 'werkt', 'morgen'], correctAnswer: 'Mijn moeder werkt morgen' },
        { id: 'm2l3e-43', type: 'multiple_choice', prompt: 'Corrige: "Ik morgen bezoek mijn oma"', options: ['Ik bezoek mijn oma morgen', 'Ik morgen bezoek mijn oma', 'Morgen ik bezoek mijn oma', 'Bezoek ik morgen oma'], correctAnswer: 'Ik bezoek mijn oma morgen', explanation: 'El verbo va en el lugar dos. El tiempo, al final (o al principio, pero entonces el verbo sigue segundo: "Morgen bezoek ik mijn oma").' },
        { id: 'm2l3e-44', type: 'multiple_choice', prompt: '¿Cuál es correcta?', options: ['Wij zien onze familie in augustus', 'Wij zien onze familie op augustus', 'Wij zien onze familie om augustus', 'Wij ziet onze familie in augustus'], correctAnswer: 'Wij zien onze familie in augustus', explanation: 'Los meses van con "in", y wij → zien.' },
        { id: 'm2l3e-45', type: 'true_false', prompt: '"Ik werk met mijn vriendin in woensdag" está bien.', correctAnswer: 'falso', explanation: 'Los días van con "op": op woensdag.' },
        { id: 'm2l3e-46', type: 'true_false', prompt: '"Mijn moeder werkt morgen" está bien.', correctAnswer: 'verdadero', explanation: 'Sujeto, verbo, tiempo. Perfecta.' },
        { id: 'm2l3e-47', type: 'multiple_choice', prompt: 'Corrige: "Wij ziet onze familie dit weekend"', options: ['Wij zien onze familie dit weekend', 'Wij ziet onze familie dit weekend', 'Wij zie onze familie dit weekend', 'Wij zient onze familie dit weekend'], correctAnswer: 'Wij zien onze familie dit weekend', explanation: 'Wij → zien (plural, verbo entero).' },
      ],
    },
    { type: 'review' },
  ],
  ...
  blocks: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: '**Nuestro/a/os/as** es el único posesivo que en neerlandés tiene dos formas: **ons** y **onze**. Se usa **ons** cuando la palabra lleva *het*: *ons huis*, *ons gezin*. Se usa **onze** cuando la palabra lleva *de*: *onze moeder*, *onze auto*. Y como en plural todo lleva *de*, en plural es siempre **onze**: *onze families*, *onze landen*, *onze vrienden*.',
        },
        {
...
El jardín suele ser pequeño, pero es importante. El sábado media Países Bajos trabaja en el jardín. Quien no tiene jardín, pone flores en el balcón.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm2l4e-27', type: 'write_answer', prompt: 'Escribe en neerlandés: "Tengo un novio"', correctAnswer: 'Ik heb een vriend', hint: 'hebben → con ik va la raíz' },
        ...
        // ── Del pack de ejercicios del profe (parte 4: de/het, posesivos, ons/onze) ──
        { id: 'm2l4e-39', type: 'match_pairs', prompt: 'Une cada posesivo con su traducción', correctAnswer: '', pairs: [
          { left: 'jouw', right: 'tu' },
          { left: 'zijn', right: 'su (de él)' },
          { left: 'haar', right: 'su (de ella)' },
          { left: 'uw', right: 'su (de usted)' },
        ...
        { id: 'm2l4e-40', type: 'fill_blank', prompt: '___ tante (de / het)', correctAnswer: 'de', hint: 'personas casi siempre "de"' },
        { id: 'm2l4e-41', type: 'fill_blank', prompt: '___ gezin (de / het)', correctAnswer: 'het', hint: 'excepción: het gezin' },
        { id: 'm2l4e-42', type: 'fill_blank', prompt: '___ neef (de / het)', correctAnswer: 'de', hint: 'el primo / el sobrino' },
        { id: 'm2l4e-43', type: 'fill_blank', prompt: 'Dit is ___ oom. (yo)', correctAnswer: 'mijn' },
        { id: 'm2l4e-44', type: 'fill_blank', prompt: 'Dit is ___ tante. (ella)', correctAnswer: 'haar', hint: 'de ella' },
        { id: 'm2l4e-45', type: 'fill_blank', prompt: 'Dit is ___ broer. (él)', correctAnswer: 'zijn', hint: 'de él' },
        { id: 'm2l4e-46', type: 'fill_blank', prompt: '___ huis (nuestro: ons / onze)', correctAnswer: 'ons', hint: 'huis es palabra de "het"' },
        { id: 'm2l4e-47', type: 'fill_blank', prompt: '___ kinderen (nuestro: ons / onze)', correctAnswer: 'onze', hint: 'Mira si kinderen es de o het (los plurales siempre son de)' },
        { id: 'm2l4e-48', type: 'fill_blank', prompt: '___ dorp (nuestro: ons / onze)', correctAnswer: 'ons', hint: 'het dorp = el pueblo' },
        { id: 'm2l4e-49', type: 'multiple_choice', prompt: 'Corrige: "Ons familie is groot"', options: ['Onze familie is groot', 'Ons familie is groot', 'Onze familie zijn groot', 'Ons familie zijn groot'], correctAnswer: 'Onze familie is groot', explanation: 'De familie → onze. Ons solo con palabras de "het" en singular.' },
        { id: 'm2l4e-50', type: 'multiple_choice', prompt: 'Corrige: "Dit is tante mijn"', options: ['Dit is mijn tante', 'Dit is tante mijn', 'Dit mijn is tante', 'Mijn is dit tante'], correctAnswer: 'Dit is mijn tante', explanation: 'El posesivo va DELANTE del nombre, como en español.' },
        { id: 'm2l4e-51', type: 'multiple_choice', prompt: 'Corrige: "Ik heb de partner"', options: ['Ik heb een partner', 'Ik heb de partner', 'Ik heb het partner', 'Ik heb partner'], correctAnswer: 'Ik heb een partner', explanation: 'Cuando dices que tienes pareja, en general: "een".' },
      ],
    },
    { type: 'review' },
  ],
...
El fin de semana el reloj es menos estricto. El sábado la gente hace la compra. El domingo mucha gente duerme hasta tarde.`,
    ...
    },
    {
      ...
      exercises: [
        { id: 'm2d5q-1', type: 'multiple_choice', prompt: 'Hoe laat eten ze in Nederland?', options: ['Om 6 uur', 'Om 8 uur', 'Om 10 uur', 'Om 7 uur'], correctAnswer: 'Om 6 uur', explanation: '"Om 6 uur in de avond". En el Lezen lo leíste; aquí lo oyes.' },
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Escribir ──
        { id: 'm2l5e-27', type: 'write_answer', prompt: 'Escribe en neerlandés: "Trabajo el lunes"', correctAnswer: 'Ik werk op maandag', hint: 'Día → ¿qué preposición?' },
        ...
        // ── Escuchar y traducir (frases de la lección) ──
        { id: 'm2l5e-34', type: 'true_false', prompt: '"Ik eet op 6 uur" es correcto.', correctAnswer: 'falso', explanation: 'Con horas es OM: ik eet om 6 uur. Op es para los días.' },
        ...
        { id: 'm2l5e-36', type: 'listen_translate', prompt: 'Escucha y traduce: "Ik sport in de avond"', options: ['Hago', 'deporte', 'por', 'la', 'tarde', 'mañana', 'trabajo', 'noche'], correctAnswer: 'Hago deporte por la tarde', alsoAccept: ['Hago deporte por la noche'] },
        ...
        // ── Del pack de ejercicios del profe (parte 5: om / op / in) ──
        { id: 'm2l5e-39', type: 'fill_blank', prompt: 'Ik werk ___ maandag.', correctAnswer: 'op', hint: 'días' },
        { id: 'm2l5e-40', type: 'fill_blank', prompt: 'Ik eet ___ 7 uur.', correctAnswer: 'om', hint: 'horas' },
        { id: 'm2l5e-41', type: 'fill_blank', prompt: 'Mijn vader is jarig ___ april.', correctAnswer: 'in', hint: 'meses' },
        { id: 'm2l5e-42', type: 'fill_blank', prompt: 'Ik studeer ___ de avond.', correctAnswer: 'in', hint: 'momentos del día' },
        { id: 'm2l5e-43', type: 'fill_blank', prompt: 'Wij zien onze familie ___ het weekend.', correctAnswer: 'in', hint: 'in het weekend' },
        { id: 'm2l5e-44', type: 'multiple_choice', prompt: 'Corrige: "Ik werk in maandag"', options: ['Ik werk op maandag', 'Ik werk om maandag', 'Ik werk in maandag', 'Ik werk maandag op'], correctAnswer: 'Ik werk op maandag', explanation: 'Días → op.' },
        { id: 'm2l5e-45', type: 'multiple_choice', prompt: 'Corrige: "Mijn vader is jarig op mei"', options: ['Mijn vader is jarig in mei', 'Mijn vader is jarig om mei', 'Mijn vader is jarig op mei', 'Mijn vader is jarig mei'], correctAnswer: 'Mijn vader is jarig in mei', explanation: 'Meses → in.' },
        { id: 'm2l5e-46', type: 'multiple_choice', prompt: 'Corrige: "Ik werk om de avond"', options: ['Ik werk in de avond', 'Ik werk op de avond', 'Ik werk om de avond', 'Ik werk de avond'], correctAnswer: 'Ik werk in de avond', explanation: 'Momentos del día → in. También vale "’s avonds".' },
        { id: 'm2l5e-47', type: 'fill_blank', prompt: 'Ik werk ___ maandag ___ 8 uur.', correctAnswer: 'op om', hint: 'día, luego hora' },
        { id: 'm2l5e-48', type: 'fill_blank', prompt: 'Ik studeer ___ de ochtend ___ 9 uur.', correctAnswer: 'in om', hint: 'momento del día, luego hora' },
        { id: 'm2l5e-49', type: 'order_sentence', prompt: 'Ordena: "Mi madre cumple años en junio"', options: ['Mijn moeder', 'is', 'jarig', 'in juni'], correctAnswer: 'Mijn moeder is jarig in juni' },
        { id: 'm2l5e-50', type: 'write_answer', prompt: 'Responde con frase entera: "Hoe laat werk je op maandag?" (a las 8)', correctAnswer: 'Ik werk om 8 uur', hint: 'Contesta con el verbo de la pregunta · la hora va con om … uur' },
      ],
    },
    { type: 'review' },
  ],
...
Junto a la estación de Utrecht está el aparcamiento de bicis más grande del mundo. Ahí caben más de doce mil bicis.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2d6q-5', type: 'true_false', prompt: 'David dice "mijn vriendin Anna".', correctAnswer: 'verdadero', explanation: 'Sí lo dice: "Dit is mijn vriendin Anna". Y Anna le corrige enseguida: era "een vriendin", una amiga. Justo la trampa de la lección 1.' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l6e-32', type: 'fill_blank', prompt: 'REPASO: Ik bezoek mijn oma ___ zondag ___ 3 uur.', correctAnswer: 'op om', hint: 'Día y hora (lecciones 3 y 5)', explanation: 'Día → op · hora → om.' },
        ...
        // ── Del pack de ejercicios del profe (parte final: el gran repaso del módulo) ──
        { id: 'm2l6e-39', type: 'match_pairs', prompt: 'REPASO: al neerlandés, con su artículo', correctAnswer: '', pairs: [
          { left: 'la madre', right: 'de moeder' },
          { left: 'el hermano', right: 'de broer' },
          { left: 'la casa', right: 'het huis' },
          { left: 'el trabajo', right: 'het werk' },
          { left: 'los hijos', right: 'de kinderen' },
          { left: 'la amiga', right: 'de vriendin' },
        ] },
        { id: 'm2l6e-40', type: 'order_sentence', prompt: 'REPASO: "Comemos juntos el domingo"', options: ['Wij', 'eten', 'samen', 'op zondag'], correctAnswer: 'Wij eten samen op zondag' },
        { id: 'm2l6e-41', type: 'fill_blank', prompt: 'REPASO: Ik ___ (hebben) een vriend.', correctAnswer: 'heb', hint: 'hebben con ik' },
        { id: 'm2l6e-42', type: 'fill_blank', prompt: 'REPASO: Mijn broer ___ (studeren) in Amsterdam.', correctAnswer: 'studeert', hint: 'raíz + t' },
        { id: 'm2l6e-43', type: 'fill_blank', prompt: 'REPASO: Dit is ___ vader. (su padre, de ella)', correctAnswer: 'haar' },
        { id: 'm2l6e-44', type: 'fill_blank', prompt: 'REPASO: Dit is ___ vriend. (su amigo, de él)', correctAnswer: 'zijn' },
        { id: 'm2l6e-45', type: 'multiple_choice', prompt: 'REPASO: Corrige "Dit zijn ons ouders"', options: ['Dit zijn onze ouders', 'Dit zijn ons ouders', 'Dit is onze ouders', 'Dit is ons ouders'], correctAnswer: 'Dit zijn onze ouders', explanation: 'Plural → onze, y dit zijn.' },
        { id: 'm2l6e-46', type: 'multiple_choice', prompt: 'REPASO: Corrige "Dit is de moeder mijn"', options: ['Dit is mijn moeder', 'Dit is de mijn moeder', 'Dit is moeder mijn', 'Dit mijn moeder is'], correctAnswer: 'Dit is mijn moeder', explanation: 'Posesivo delante, y sin artículo.' },
        { id: 'm2l6e-47', type: 'fill_blank', prompt: 'REPASO: Mijn moeder is jarig ___ mei.', correctAnswer: 'in', hint: 'meses' },
        { id: 'm2l6e-48', type: 'write_answer', prompt: 'REPASO: Escribe "Veo a mi familia mañana"', correctAnswer: 'Ik zie mijn familie morgen', hint: 'Sujeto + verbo + resto + tiempo' },
      ],
    },
    { type: 'review' },
  ],
  ...
  blocks: [
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'emnd-12', type: 'write_answer', prompt: 'Escribe en neerlandés: "Me voy de vacaciones en julio"', correctAnswer: 'Ik ga in juli op vakantie', hint: 'irse de vacaciones = op vakantie gaan · ¿dónde va el verbo?' },
      ],
    },
    { type: 'review' },
  ],
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3e-30', type: 'match_pairs', prompt: 'Une cada palabra con su traducción', correctAnswer: '', pairs: [
          { left: 'groenten', right: 'verduras' },
          { left: 'vlees', right: 'carne' },
          { left: 'vis', right: 'pescado' },
          { left: 'rijst', right: 'arroz' },
          { left: 'kaas', right: 'queso' },
          { left: 'soep', right: 'sopa' },
        ] },
        { id: 'm3e-31', type: 'true_false', prompt: 'Lee: "Ik koop brood, melk en fruit." → Compro dos cosas.', correctAnswer: 'falso', explanation: 'Tres: pan, leche y fruta.' },
        { id: 'm3e-32', type: 'true_false', prompt: 'Lee: "’s Morgens eet ik brood met kaas." → Desayuno pan con queso.', correctAnswer: 'verdadero', explanation: '’s Morgens = por la mañana.' },
        { id: 'm3e-33', type: 'true_false', prompt: 'Lee: "’s Avonds eet ik rijst en groenten." → Ceno arroz con verduras.', correctAnswer: 'verdadero', explanation: '’s Avonds = por la noche.' },
        { id: 'm3e-34', type: 'write_answer', prompt: 'Escribe con "Ik eet": "Como pan con queso"', correctAnswer: 'Ik eet brood met kaas', hint: '«con» = met' },
      ],
    },
    { type: 'review' },
  ],
...
Al final preguntas: mag ik de rekening, alstublieft? El camarero la trae a la mesa.`,
      exercises: [
        ...
        { id: 'm3l2lz-10', type: 'fill_blank', prompt: 'Mag ik de ___, alstublieft? (la cuenta)', correctAnswer: 'rekening', hint: 'Empieza por «r»' },
      ],
    },
    {
      type: 'dialogue',
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3l2e-45', type: 'fill_blank', prompt: '___ ik zitten? (mogen)', correctAnswer: 'Mag', hint: 'con ik' },
        { id: 'm3l2e-46', type: 'fill_blank', prompt: '___ wij betalen? (mogen)', correctAnswer: 'Mogen', hint: 'con wij' },
...
Casi todos los supermercados tienen una tarjeta con descuento. Sin esa tarjeta pagas más. Mucha gente lleva la app en el móvil.`,
      exercises: [
        ...
        { id: 'm3l3lz-10', type: 'fill_blank', prompt: '___ laat gaat de winkel open? (¿a qué hora?)', correctAnswer: 'Hoe', hint: 'Es la misma palabra de «… gaat het?»' },
      ],
    },
    {
      type: 'dialogue',
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Del pack de ejercicios del profe (deel 4: hacer preguntas) ──
        { id: 'm3l3e-27', type: 'order_sentence', prompt: 'Forma la pregunta: "jij / koffie drinken"', options: ['Drink', 'jij', 'koffie?'], correctAnswer: 'Drink jij koffie?', explanation: 'Pregunta de sí/no: el verbo va primero. Y con jij detrás, sin -t.' },
        { id: 'm3l3e-28', type: 'order_sentence', prompt: 'Forma la pregunta: "hij / vlees eten"', options: ['Eet', 'hij', 'vlees?'], correctAnswer: 'Eet hij vlees?' },
        { id: 'm3l3e-29', type: 'order_sentence', prompt: 'Forma la pregunta: "jullie / thee nemen"', options: ['Nemen', 'jullie', 'thee?'], correctAnswer: 'Nemen jullie thee?' },
        { id: 'm3l3e-30', type: 'order_sentence', prompt: 'Forma la pregunta: "wij / soep eten"', options: ['Eten', 'wij', 'soep?'], correctAnswer: 'Eten wij soep?' },
        { id: 'm3l3e-31', type: 'fill_blank', prompt: '___ eet jij graag? (qué)', correctAnswer: 'Wat' },
        { id: 'm3l3e-32', type: 'fill_blank', prompt: '___ koop je brood? (dónde)', correctAnswer: 'Waar' },
        { id: 'm3l3e-33', type: 'fill_blank', prompt: '___ eet je? (cuándo)', correctAnswer: 'Wanneer' },
        { id: 'm3l3e-34', type: 'fill_blank', prompt: '___ koffie wil je? (cuánto)', correctAnswer: 'Hoeveel' },
        { id: 'm3l3e-35', type: 'multiple_choice', prompt: '"Wat eet jij graag?" ¿Cuál es una respuesta correcta?', options: ['Ik eet graag pizza', 'Ik graag eet pizza', 'Graag ik eet pizza', 'Eet ik graag pizza'], correctAnswer: 'Ik eet graag pizza', explanation: 'Graag va justo después del verbo.' },
        { id: 'm3l3e-36', type: 'write_answer', prompt: 'Responde: "Waar koop je brood?" (en el supermercado)', correctAnswer: 'Ik koop brood in de supermarkt', hint: 'Repite el verbo de la pregunta · «en» = in' },
      ],
    },
    { type: 'review' },
  ],
...
Una noche en un restaurante es más cara. Un plato principal cuesta entre veinte y treinta euros. Por eso mucha gente sale a cenar solo en un cumpleaños o en una fiesta.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Del pack de ejercicios del profe (deel 5: en, maar, of, want) ──
        { id: 'm3l4e-26', type: 'fill_blank', prompt: 'Ik drink koffie ___ ik eet brood. (y)', correctAnswer: 'en' },
        { id: 'm3l4e-27', type: 'fill_blank', prompt: 'Ik wil thee ___ ik neem koffie. (pero)', correctAnswer: 'maar' },
        { id: 'm3l4e-28', type: 'fill_blank', prompt: 'Wil je thee ___ koffie? (o)', correctAnswer: 'of' },
        { id: 'm3l4e-29', type: 'fill_blank', prompt: 'Ik koop brood ___ ik heb honger. (porque)', correctAnswer: 'want' },
        { id: 'm3l4e-30', type: 'multiple_choice', prompt: 'Completa: "Ik koop fruit ___ het is gezond."', options: ['want', 'maar', 'of', 'en'], correctAnswer: 'want', explanation: 'Want = porque, y NO cambia el orden de la frase.' },
        { id: 'm3l4e-31', type: 'multiple_choice', prompt: 'Completa: "Ik wil thee, ___ er is geen thee."', options: ['maar', 'want', 'of', 'en'], correctAnswer: 'maar', explanation: 'Maar = pero.' },
        { id: 'm3l4e-32', type: 'multiple_choice', prompt: '¿Cuál sirve para preguntar entre dos opciones?', options: ['of', 'en', 'maar', 'want'], correctAnswer: 'of', explanation: '"Wil je thee of koffie?"' },
        { id: 'm3l4e-33', type: 'write_answer', prompt: 'Completa con al menos tres palabras: "Ik drink koffie en ___" (como pan)', correctAnswer: 'Ik drink koffie en ik eet brood', hint: 'Después de en, otra vez sujeto y verbo · escribe la frase entera' },
      ],
    },
    { type: 'review' },
  ],
...
Dices qué quieres y cuánto: un kilo de patatas, por favor. Con la palabra graag suena amable: quiero dos kilos de manzanas, por favor.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3l5e-25', type: 'fill_blank', prompt: 'Ik wil ___ kopjes koffie. (twee / een)', correctAnswer: 'twee', hint: 'kopjes es plural' },
        { id: 'm3l5e-26', type: 'fill_blank', prompt: 'Ik wil ___ water. (een / veel)', correctAnswer: 'veel', explanation: 'El agua no se cuenta: veel water.' },
        { id: 'm3l5e-27', type: 'fill_blank', prompt: 'Ik wil ___ suiker. (een beetje / twee)', correctAnswer: 'een beetje', explanation: 'El azúcar tampoco se cuenta: een beetje suiker.' },
        { id: 'm3l5e-28', type: 'fill_blank', prompt: 'Ik koop ___ appels. (een / veel)', correctAnswer: 'veel', hint: 'appels es plural' },
        { id: 'm3l5e-29', type: 'fill_blank', prompt: 'Jij ___ van thee. (houden van)', correctAnswer: 'houdt', hint: 'raíz + t' },
        { id: 'm3l5e-30', type: 'fill_blank', prompt: 'Ik ___ van koffie. (houden van)', correctAnswer: 'hou', hint: 'con ik se pierde la d', explanation: '"Ik hou van…" es como se dice. (Escribir "houd" también es correcto, pero nadie lo pronuncia.)' },
        ...
        { id: 'm3l5e-35', type: 'write_answer', prompt: 'Responde en frase entera: "Hoeveel broodjes neem je?" (tres)', correctAnswer: 'Ik neem drie broodjes', hint: 'Contesta con el verbo de la pregunta, en la forma de ik' },
        { id: 'm3l5e-36', type: 'write_answer', prompt: 'Escribe: "A mi mejor amigo le gusta la pizza"', correctAnswer: 'Mijn beste vriend houdt van pizza', hint: 'houdt van' },
      ],
    },
    { type: 'review' },
  ],
...
En la caja se paga con tarjeta. La cajera pregunta si quieres el tique. Mucha gente dice que no: así se ahorra papel.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        // ── Del pack de ejercicios del profe (deel 9: los diálogos del restaurante y del súper) ──
        { id: 'm3l6e-24', type: 'multiple_choice', prompt: 'En el restaurante: "Goedemiddag. Wat wil je drinken?" Contesta con educación:', options: ['Ik wil graag koffie', 'Koffie', 'Ik koffie wil', 'Geef koffie'], correctAnswer: 'Ik wil graag koffie', explanation: 'Con "graag" y frase entera.' },
        { id: 'm3l6e-25', type: 'multiple_choice', prompt: '"Nog iets?" ¿Qué te están preguntando?', options: ['¿Algo más?', '¿Cuánto?', '¿Dónde?', '¿Nada?'], correctAnswer: '¿Algo más?', explanation: 'Nog iets = algo más. Respuesta: "Ja, ik neem soep" o "Nee, dank je".' },
        { id: 'm3l6e-26', type: 'multiple_choice', prompt: '"Hoeveel wil je?" Contesta:', options: ['Ik wil twee broodjes', 'Ik wil broodjes twee', 'Twee wil ik broodjes', 'Broodjes'], correctAnswer: 'Ik wil twee broodjes', explanation: 'Número delante de la cosa, como en español.' },
        { id: 'm3l6e-27', type: 'order_sentence', prompt: 'En el súper: "¿Dónde encuentro la leche?"', options: ['Waar', 'vind', 'ik', 'de melk?'], correctAnswer: 'Waar vind ik de melk?' },
        { id: 'm3l6e-28', type: 'order_sentence', prompt: '"¿Puedo pagar con tarjeta?"', options: ['Mag', 'ik', 'pinnen?'], correctAnswer: 'Mag ik pinnen?' },
        { id: 'm3l6e-29', type: 'multiple_choice', prompt: '"De melk staat in het koelschap." ¿Dónde está la leche?', options: ['En la nevera de la tienda', 'En la caja', 'En la entrada', 'Se ha acabado'], correctAnswer: 'En la nevera de la tienda', explanation: 'Koelschap = el estante refrigerado.' },
        { id: 'm3l6e-30', type: 'multiple_choice', prompt: 'Das las gracias y te despides:', options: ['Dank u wel, fijne dag!', 'Hallo, tot straks!', 'Sorry, doei!', 'Alsjeblieft!'], correctAnswer: 'Dank u wel, fijne dag!', explanation: 'Dank u wel (gracias, de usted) + fijne dag (buen día).' },
        { id: 'm3l6e-31', type: 'write_answer', prompt: 'Pide un café y un bocadillo de queso, con educación', correctAnswer: 'Ik wil graag koffie en een broodje kaas', hint: 'La forma educada de pedir lleva graag' },
      ],
    },
    { type: 'review' },
  ],
...
Marta habla español y un poco de inglés. Para este puesto es suficiente. Mañana a las once tiene una entrevista de trabajo con el encargado del restaurante.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm4d1q-7', type: 'fill_blank', prompt: 'Ik ben op zoek naar een ___. (un empleo)', correctAnswer: 'baan', hint: 'Empieza por «b»', explanation: '"Een baan zoeken" = buscar trabajo.' },
      ],
    },
    {
...
Hoy es martes y la tienda está tranquila. Marta está contenta: tiene tiempo para aprenderlo todo.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm4l2e-5',  type: 'fill_blank', prompt: 'Ik ___ Carlos en ik ___ leraar. (ser)', correctAnswer: 'ben ben', hint: 'la misma forma las dos veces', explanation: 'Ik ben Carlos en ik ben leraar.' },
...
Los viernes el taller está cerrado. Kees aprovecha ese día para hacer la compra y para visitar a su madre.`,
      exercises: [
        ...
        { id: 'm4l3lz-7', type: 'fill_blank', prompt: 'Ik werk ___ geld ___ sparen. (para ahorrar dinero)', correctAnswer: 'om te', hint: 'la estructura de esta lección', explanation: 'Om + complemento + te + infinitivo: "om geld te sparen".' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm4d3q-6', type: 'fill_blank', prompt: 'Ik gebruik mijn vrije dag ___ boodschappen ___ doen.', correctAnswer: 'om te', hint: 'las dos palabras de la estructura', explanation: 'Om ... te + infinitivo, con el complemento en medio.' },
...
Los viernes por la tarde queda con sus compañeros. Cenan sobre las siete juntos en el centro.`,
      exercises: [
        ...
        { id: 'm4l4lz-7', type: 'fill_blank', prompt: 'De vergadering is ___ twee ___ drie uur. (de dos a tres)', correctAnswer: 'van tot', hint: 'de … a …', explanation: 'Van ... tot ... = de ... a ...' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm4d4q-6', type: 'fill_blank', prompt: 'Hoe ___ spreken we af? (a qué hora)', correctAnswer: 'laat', hint: 'Literalmente se pregunta «¿cómo de tarde?»', explanation: 'Literalmente "qué tan tarde". Es LA pregunta para la hora.' },
...
A las nueve la bici está lista. El cielo está azul y Gerard se pone en camino tan contento.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm4d6q-6', type: 'fill_blank', prompt: 'Het is zo ___, hoor. (listo, terminado)', correctAnswer: 'klaar', hint: 'Empieza por «k»', explanation: '"Zo klaar" = listo enseguida. Y "hoor" al final suaviza la frase; no se traduce.' },
