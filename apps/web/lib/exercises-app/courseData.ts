...
Por la noche David cena en casa de su vecina Els. Llama al timbre y dice «goedenavond». Els le pregunta qué tal fue. David dice que estuvo muy a gusto.`,
    ...
    },
    {
      ...
      dialogue: {
        ...
        lines: [
          ...
          { id: 'm1d1-9', speaker: 'Anna', dutch: 'Ik woon in Haarlem. Hoe oud ben je?', spanish: 'Yo vivo en Haarlem. ¿Cuántos años tienes?' },
          { id: 'm1d1-10', speaker: 'David', dutch: 'Ik ben vijfendertig jaar. En jij?', spanish: 'Tengo treinta y cinco años. ¿Y tú?' },
          { id: 'm1d1-11', speaker: 'Anna', dutch: 'Ik ben achtentwintig. Je spreekt al goed Nederlands!', spanish: 'Yo tengo veintiocho. ¡Ya hablas bien neerlandés!' },
      ...
      exercises: [
        ...
        { id: 'm1d1q-4', type: 'multiple_choice', prompt: '¿Cuántos años tiene David?', options: ['35', '28', '25', '40'], correctAnswer: '35', explanation: '"Ik ben vijfendertig jaar".' },
        { id: 'm1d1q-5', type: 'multiple_choice', prompt: '¿Cuántos años tiene Anna?', options: ['28', '35', '30', '22'], correctAnswer: '28', explanation: '"Ik ben achtentwintig".' },
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l1e-38', type: 'listen_translate', prompt: 'Escucha y traduce: "Ik ben vijfendertig jaar"', options: ['Tengo', 'treinta', 'y', 'cinco', 'años', 'Soy', 'español', 'veinte'], correctAnswer: 'Tengo treinta y cinco años' },
...
Sofía y Pablo`,
    ...
    },
    {
      ...
      dialogue: {
        id: 'm1d2',
        title: 'Wie is wie?',
        context: 'De tweede afspraak. David komt met zijn vriend Pablo. Let op de woordjes ik, jij, hij, zij, wij en jullie.',
        lines: [
          ...
          { id: 'm1d2-4', speaker: 'David', dutch: 'Nee, mijn vriend Pablo komt ook. Hij is er zo.', spanish: 'No, mi amigo Pablo viene también. Llega enseguida.' },
          { id: 'm1d2-5', speaker: 'Anna', dutch: 'Wat doet hij?', spanish: '¿A qué se dedica él?' },
          { id: 'm1d2-6', speaker: 'David', dutch: 'Hij is schilder. En jij? Wat doe jij?', spanish: 'Es pintor. ¿Y tú? ¿A qué te dedicas?' },
          ...
          { id: 'm1d2-13', speaker: 'Ober', dutch: 'Goedemiddag. Wilt u iets drinken?', spanish: 'Buenas tardes. ¿Quieren tomar algo?' },
          { id: 'm1d2-14', speaker: 'David', dutch: 'Ja, voor mij een koffie.', spanish: 'Sí, para mí un café.' },
          { id: 'm1d2-15', speaker: 'Anna', dutch: 'En voor mij een thee, graag.', spanish: 'Y para mí un té, por favor.' },
          { id: 'm1d2-16', speaker: 'David', dutch: 'Wij drinken hier elke week koffie en thee.', spanish: 'Nosotros tomamos aquí café y té todas las semanas.' },
          { id: 'm1d2-17', speaker: 'Anna', dutch: 'En volgende week zijn jullie met zijn tweeën. Gezellig!', spanish: 'Y la semana que viene sois dos. ¡Qué bien!' },
        ],
      },
      exercises: [
        { id: 'm1d2q-1', type: 'multiple_choice', prompt: '¿Quién viene con David?', options: ['Su amigo Pablo', 'Su hermana', 'Su vecino', 'Nadie'], correctAnswer: 'Su amigo Pablo', explanation: '"mijn vriend Pablo komt ook".' },
        { id: 'm1d2q-2', type: 'multiple_choice', prompt: '¿A qué se dedica Pablo?', options: ['Es pintor', 'Es médico', 'Es profesor', 'Es camarero'], correctAnswer: 'Es pintor', explanation: '"Hij is schilder".' },
        ...
        { id: 'm1d2q-7', type: 'fill_blank', prompt: '___ u iets drinken? (forma de usted)', correctAnswer: 'Wilt', hint: 'con u el verbo acaba en -t', explanation: 'El camarero trata de usted: "Wilt u iets drinken?"' },
        { id: 'm1d2q-8', type: 'multiple_choice', prompt: '¿Cuál es la diferencia entre "jij" y "u"?', options: ['u es la forma formal', 'Son lo mismo', 'u es plural', 'jij solo se usa por escrito'], correctAnswer: 'u es la forma formal', explanation: 'El camarero dice "u"; entre amigos se dice "jij" o "je".' },
      ],
    },
    {
      type: 'practice',
...
David hoy trabaja en casa. Aprende neerlandés y piensa todo el día en las palabras nuevas. Por la noche llama a Anna y hablan neerlandés juntos. Así David practica todos los verbos de esta lección: ¡trabajar, esperar, cocinar, llamar y aprender!`,
    ...
    },
    {
      ...
      dialogue: {
        id: 'm1d3',
        title: 'Anna helpt met de werkwoorden',
        context: 'David maakt zijn huiswerk in het café. Anna legt uit hoe je een werkwoord vervoegt.',
        lines: [
          { id: 'm1d3-1', speaker: 'Anna', dutch: 'Hoi David! Wacht je al lang?', spanish: '¡Hola David! ¿Llevas mucho esperando?' },
          { id: 'm1d3-2', speaker: 'David', dutch: 'Nee, ik wacht vijf minuten.', spanish: 'No, llevo cinco minutos esperando.' },
          { id: 'm1d3-3', speaker: 'Anna', dutch: 'Wat doe je?', spanish: '¿Qué haces?' },
          { id: 'm1d3-4', speaker: 'David', dutch: 'Ik studeer. Ik leer de werkwoorden.', spanish: 'Estudio. Estoy aprendiendo los verbos.' },
          { id: 'm1d3-5', speaker: 'Anna', dutch: 'Wil je hulp?', spanish: '¿Quieres ayuda?' },
          { id: 'm1d3-6', speaker: 'David', dutch: 'Graag. Ik maak veel fouten.', spanish: 'Sí, por favor. Cometo muchos errores.' },
          { id: 'm1d3-7', speaker: 'Anna', dutch: 'Dat is normaal. Kijk: ik werk, jij werkt, hij werkt.', spanish: 'Es normal. Mira: yo trabajo, tú trabajas, él trabaja.' },
          { id: 'm1d3-8', speaker: 'David', dutch: 'En wij?', spanish: '¿Y nosotros?' },
          { id: 'm1d3-9', speaker: 'Anna', dutch: 'Wij werken. Jullie werken. Zij werken.', spanish: 'Nosotros trabajamos. Vosotros trabajáis. Ellos trabajan.' },
          { id: 'm1d3-10', speaker: 'David', dutch: 'Dus jij en hij krijgen een t?', spanish: '¿Así que tú y él llevan una t?' },
          { id: 'm1d3-11', speaker: 'Anna', dutch: 'Precies. Bij ik niet.', spanish: 'Exacto. Con "ik" no.' },
          { id: 'm1d3-12', speaker: 'David', dutch: 'Ik leer, jij leert, hij leert. Klopt dat?', spanish: 'Ik leer, jij leert, hij leert. ¿Está bien?' },
          { id: 'm1d3-13', speaker: 'Anna', dutch: 'Heel goed! Je leert snel.', spanish: '¡Muy bien! Aprendes rápido.' },
          { id: 'm1d3-14', speaker: 'David', dutch: 'Dank je. Ik studeer elke dag een half uur.', spanish: 'Gracias. Estudio media hora todos los días.' },
          { id: 'm1d3-15', speaker: 'Anna', dutch: 'Dat helpt echt. Vraag het altijd aan mij.', spanish: 'Eso ayuda de verdad. Pregúntame siempre.' },
          { id: 'm1d3-16', speaker: 'David', dutch: 'Bel je me morgen?', spanish: '¿Me llamas mañana?' },
          { id: 'm1d3-17', speaker: 'Anna', dutch: 'Ja, ik bel je om zes uur. Tot morgen!', spanish: 'Sí, te llamo a las seis. ¡Hasta mañana!' },
        ],
      },
      exercises: [
        { id: 'm1d3q-1', type: 'multiple_choice', prompt: '¿Cuánto lleva esperando David?', options: ['Cinco minutos', 'Media hora', 'Una hora', 'Diez minutos'], correctAnswer: 'Cinco minutos', explanation: '"ik wacht vijf minuten".' },
        { id: 'm1d3q-2', type: 'multiple_choice', prompt: '¿Qué está estudiando David?', options: ['Los verbos', 'Los números', 'El alfabeto', 'Los colores'], correctAnswer: 'Los verbos', explanation: '"Ik leer de werkwoorden".' },
        { id: 'm1d3q-3', type: 'multiple_choice', prompt: 'Según Anna, ¿quiénes llevan una -t?', options: ['jij y hij', 'ik y wij', 'jullie y zij', 'Todos'], correctAnswer: 'jij y hij', explanation: '"ik werk, jij werkt, hij werkt". Con ik, no.' },
        { id: 'm1d3q-4', type: 'multiple_choice', prompt: '¿Cuánto estudia David cada día?', options: ['Media hora', 'Una hora', 'Cinco minutos', 'Dos horas'], correctAnswer: 'Media hora', explanation: '"Ik studeer elke dag een half uur".' },
        { id: 'm1d3q-5', type: 'multiple_choice', prompt: '¿A qué hora le llama Anna?', options: ['A las seis', 'A las siete', 'A las cinco', 'A las ocho'], correctAnswer: 'A las seis', explanation: '"ik bel je om zes uur".' },
        { id: 'm1d3q-6', type: 'true_false', prompt: 'Con "ik" el verbo lleva una -t.', correctAnswer: 'falso', explanation: 'Con ik va la raíz sola: ik werk, ik leer.' },
        { id: 'm1d3q-7', type: 'fill_blank', prompt: 'Wij ___ samen. (trabajamos)', correctAnswer: 'werken', hint: 'con wij el verbo va entero', explanation: 'Wij, jullie y zij llevan el infinitivo: werken.' },
        { id: 'm1d3q-8', type: 'multiple_choice', prompt: '¿Cómo se dice "él aprende"?', options: ['hij leert', 'hij leer', 'hij leren', 'hij lert'], correctAnswer: 'hij leert', explanation: 'Raíz leer + t.' },
      ],
    },
    {
      type: 'practice',
...
Una cosa más: en neerlandés se dice primero la unidad y luego la decena. Veinticuatro es, literalmente, cuatro-y-veinte. Cuesta acostumbrarse siendo hispanohablante, pero después de esta lección te sabrás todos los números.`,
    ...
    },
    {
      ...
      dialogue: {
        ...
        context: 'Anna en David rekenen af en praten over leeftijd, huisnummer en telefoonnummer. Let goed op de getallen.',
        lines: [
          { id: 'm1d4-1', speaker: 'Anna', dutch: 'Hoi David! Wat drink je?', spanish: '¡Hola David! ¿Qué tomas?' },
          { id: 'm1d4-2', speaker: 'David', dutch: 'Een koffie. Hoeveel kost die?', spanish: 'Un café. ¿Cuánto cuesta?' },
          { id: 'm1d4-3', speaker: 'Anna', dutch: 'De koffie kost twee euro vijftig.', spanish: 'El café cuesta dos euros cincuenta.' },
          { id: 'm1d4-4', speaker: 'David', dutch: 'En de thee?', spanish: '¿Y el té?' },
          { id: 'm1d4-5', speaker: 'Anna', dutch: 'De thee kost twee euro. Samen vier euro vijftig.', spanish: 'El té cuesta dos euros. En total cuatro cincuenta.' },
          { id: 'm1d4-6', speaker: 'David', dutch: 'Ik heb tien euro. Dus ik krijg vijf euro vijftig terug.', spanish: 'Tengo diez euros. Así que me devuelven cinco cincuenta.' },
          { id: 'm1d4-7', speaker: 'Anna', dutch: 'Klopt. Hoe oud ben je, David?', spanish: 'Correcto. ¿Cuántos años tienes, David?' },
          { id: 'm1d4-8', speaker: 'David', dutch: 'Ik ben vijfendertig. En jij?', spanish: 'Tengo treinta y cinco. ¿Y tú?' },
          { id: 'm1d4-9', speaker: 'Anna', dutch: 'Ik ben achtentwintig. Op welk nummer woon je?', spanish: 'Yo tengo veintiocho. ¿En qué número vives?' },
          { id: 'm1d4-10', speaker: 'David', dutch: 'Ik woon op nummer twaalf.', spanish: 'Vivo en el número doce.' },
          { id: 'm1d4-11', speaker: 'Anna', dutch: 'En wat is je telefoonnummer?', spanish: '¿Y cuál es tu número de teléfono?' },
          { id: 'm1d4-12', speaker: 'David', dutch: 'Nul zes, acht zeven, zes vijf, vier drie, twee één.', spanish: 'Cero seis, ocho siete, seis cinco, cuatro tres, dos uno.' },
          { id: 'm1d4-13', speaker: 'Anna', dutch: 'Dank je. Ik bel je morgen om zeven uur.', spanish: 'Gracias. Te llamo mañana a las siete.' },
          { id: 'm1d4-14', speaker: 'David', dutch: 'Prima. Tot morgen!', spanish: 'Perfecto. ¡Hasta mañana!' },
        ],
      },
      exercises: [
        { id: 'm1d4q-1', type: 'multiple_choice', prompt: '¿Cuánto cuesta el café?', options: ['2,50 €', '2 €', '4,50 €', '5,50 €'], correctAnswer: '2,50 €', explanation: '"De koffie kost twee euro vijftig".' },
        { id: 'm1d4q-2', type: 'multiple_choice', prompt: '¿Cuánto cuesta el té?', options: ['2 €', '2,50 €', '3 €', '1,50 €'], correctAnswer: '2 €', explanation: '"De thee kost twee euro".' },
        { id: 'm1d4q-3', type: 'multiple_choice', prompt: '¿Cuánto es en total?', options: ['4,50 €', '5,50 €', '4 €', '5 €'], correctAnswer: '4,50 €', explanation: '"Samen vier euro vijftig".' },
        { id: 'm1d4q-4', type: 'multiple_choice', prompt: '¿Cuánto le devuelven a David?', options: ['5,50 €', '4,50 €', '6 €', '5 €'], correctAnswer: '5,50 €', explanation: 'Paga con diez: "ik krijg vijf euro vijftig terug".' },
        { id: 'm1d4q-5', type: 'multiple_choice', prompt: '¿En qué número vive David?', options: ['El doce', 'El dos', 'El veinte', 'El diez'], correctAnswer: 'El doce', explanation: '"Ik woon op nummer twaalf".' },
        { id: 'm1d4q-6', type: 'multiple_choice', prompt: '¿A qué hora le llama Anna mañana?', options: ['A las siete', 'A las seis', 'A las ocho', 'A las nueve'], correctAnswer: 'A las siete', explanation: '"Ik bel je morgen om zeven uur".' },
        { id: 'm1d4q-7', type: 'true_false', prompt: 'Anna tiene treinta y cinco años.', correctAnswer: 'falso', explanation: 'Anna tiene veintiocho; los treinta y cinco son de David.' },
        { id: 'm1d4q-8', type: 'fill_blank', prompt: '___ kost het? (¿cuánto?)', correctAnswer: 'Hoeveel', hint: 'una sola palabra', explanation: '"Hoeveel kost het?" es la pregunta del precio.' },
      ],
    },
    {
      type: 'practice',
