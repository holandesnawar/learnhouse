...
Comer en los Países Bajos es, pues, sencillo pero agradable. ¿Y tú? ¿Prefieres dulce o salado?`,
    ...
    },
    {
      ...
      dialogue: {
        id: 'm3d4',
        title: 'Radio Nawar – Het nieuws over eten',
        context: 'Een mini-nieuwsbericht op de radio: een presentator en een verslaggever. Vol voegwoorden (en, maar, of, want).',
        lines: [
          { id: 'm3d4-1',  speaker: 'Presentator', dutch: 'Goedemiddag, hier is het nieuws. Vandaag praten we over eten in Nederland.', spanish: 'Buenas tardes, aquí están las noticias. Hoy hablamos sobre la comida en los Países Bajos.' },
          { id: 'm3d4-2',  speaker: 'Verslaggever', dutch: 'Klopt. Steeds minder mensen koken zelf, want sinds twintig twintig bestellen we veel meer eten thuis.', spanish: 'Exacto. Cada vez menos gente cocina, porque desde 2020 pedimos mucha más comida a casa.' },
          { id: 'm3d4-3',  speaker: 'Presentator', dutch: 'En waarom bestellen mensen zo veel?',                         spanish: '¿Y por qué pide la gente tanto?' },
          { id: 'm3d4-4',  speaker: 'Verslaggever', dutch: 'Mensen hebben weinig tijd, en bestellen is makkelijk. Pizza, sushi of een broodje: alles komt naar je huis.', spanish: 'La gente tiene poco tiempo, y pedir es fácil. Pizza, sushi o un bocadillo: todo llega a tu casa.' },
          { id: 'm3d4-5',  speaker: 'Presentator', dutch: 'Maar koken is gezonder, toch?',                              spanish: 'Pero cocinar es más sano, ¿verdad?' },
          { id: 'm3d4-6',  speaker: 'Verslaggever', dutch: 'Ja, dat is waar. Thuis koken is goedkoper en vaak gezonder, maar veel mensen vinden samen koken ook gezellig.', spanish: 'Sí, es verdad. Cocinar en casa es más barato y a menudo más sano, pero a mucha gente le parece agradable cocinar juntos.' },
          { id: 'm3d4-7',  speaker: 'Presentator', dutch: 'En wat eten Nederlanders het liefst?',                       spanish: '¿Y qué comen los neerlandeses con más gusto?' },
          { id: 'm3d4-8',  speaker: 'Verslaggever', dutch: 'Friet, pizza en pasta zijn favoriet, maar groente en fruit blijven belangrijk.', spanish: 'Las patatas fritas, la pizza y la pasta son las favoritas, pero la verdura y la fruta siguen siendo importantes.' },
          { id: 'm3d4-9',  speaker: 'Presentator', dutch: 'Bedankt voor het nieuws. Tot morgen!',                        spanish: 'Gracias por las noticias. ¡Hasta mañana!' },
          { id: 'm3d4-10', speaker: 'Verslaggever', dutch: 'Tot morgen, en... eet smakelijk!',                          spanish: 'Hasta mañana, y... ¡buen provecho!' },
        ],
      },
    },
    {
