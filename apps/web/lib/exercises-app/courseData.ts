...
Junto al mar sopla el viento casi todos los días. Por eso en Países Bajos hay muchos molinos.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm1l6e-25', type: 'write_answer', prompt: 'Escribe en neerlandés: "El sol brilla"', correctAnswer: 'De zon schijnt', hint: 'schijnen = brillar · sin punto final' },
        // ── Escuchar ──
...
Casi todo el mundo tiene una bici. En Países Bajos hay más bicis que personas: unos veintitrés millones.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l2e-49', type: 'write_answer', prompt: 'De lista a frase: "mijn broer – Utrecht – studeren"', correctAnswer: 'Mijn broer studeert in Utrecht', hint: 'Sujeto + verbo + in + ciudad · sin punto final' },
        { id: 'm2l2e-50', type: 'write_answer', prompt: 'De lista a frase: "mijn ouders – Nederland – werken"', correctAnswer: 'Mijn ouders werken in Nederland', hint: 'plural → verbo entero · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
El jardín suele ser pequeño, pero es importante. El sábado media Países Bajos trabaja en el jardín. Quien no tiene jardín, pone flores en el balcón.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l4e-47', type: 'fill_blank', prompt: '___ kinderen (nuestro: ons / onze)', correctAnswer: 'onze', hint: 'plural → siempre onze' },
...
El fin de semana el reloj es menos estricto. El sábado la gente hace la compra. El domingo mucha gente duerme hasta tarde.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l5e-50', type: 'write_answer', prompt: 'Responde con frase entera: "Hoe laat werk je op maandag?" (a las 8)', correctAnswer: 'Ik werk om 8 uur', hint: 'Ik werk om … uur · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
Junto a la estación de Utrecht está el aparcamiento de bicis más grande del mundo. Ahí caben más de doce mil bicis.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm2l6e-48', type: 'write_answer', prompt: 'REPASO: Escribe "Veo a mi familia mañana"', correctAnswer: 'Ik zie mijn familie morgen', hint: 'Sujeto + verbo + resto + tiempo · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
Un plato clásico tiene tres partes: patatas, verdura y carne o pescado. A las seis la familia está sentada a la mesa.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3e-34', type: 'write_answer', prompt: 'Escribe con "Ik eet": "Como pan con queso"', correctAnswer: 'Ik eet brood met kaas', hint: 'brood met kaas · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
Casi todos los supermercados tienen una tarjeta con descuento. Sin esa tarjeta pagas más. Mucha gente lleva la app en el móvil.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3l3e-36', type: 'write_answer', prompt: 'Responde: "Waar koop je brood?" (en el supermercado)', correctAnswer: 'Ik koop brood in de supermarkt', hint: 'Ik koop brood in de … · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
Una noche en un restaurante es más cara. Un plato principal cuesta entre veinte y treinta euros. Por eso mucha gente sale a cenar solo en un cumpleaños o en una fiesta.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3l4e-33', type: 'write_answer', prompt: 'Completa con al menos tres palabras: "Ik drink koffie en ___" (como pan)', correctAnswer: 'Ik drink koffie en ik eet brood', hint: 'en + ik eet brood · escribe la frase entera, sin punto final' },
      ],
    },
    { type: 'review' },
  ],
...
En la caja se paga con tarjeta. La cajera pregunta si quieres el tique. Mucha gente dice que no: así se ahorra papel.`,
    ...
    },
    {
      ...
      exercises: [
        ...
        { id: 'm3l6e-31', type: 'write_answer', prompt: 'Pide un café y un bocadillo de queso, con educación', correctAnswer: 'Ik wil graag koffie en een broodje kaas', hint: 'Ik wil graag … en een … · sin punto final' },
      ],
    },
    { type: 'review' },
  ],
