  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-screen">
        ...
        <div className={`flex flex-1 min-w-0 flex-col transition-[padding] duration-200 ${isLessonPage ? 'lg:pl-[var(--course-sidebar-w,340px)]' : 'pt-14 md:pt-0 md:pl-[var(--org-collapsed-pad,0px)]'}`}>
