...
/**
 * Las preguntas de la formación.
 *
 * Van como respaldo para cualquier curso que no tenga las suyas propias (hoy,
 * la Formación A0-A1; mañana, la A1-A2), así no hay que tocar el código cada
 * vez que se crea un curso. El equipo puede reescribirlas desde la propia
 * pantalla y lo que guarde manda sobre esto.
 *
 * Son las dudas que de verdad aparecen dentro de una formación: el ritmo, el
 * orden, por qué no se ven todos los módulos, qué hacer cuando no entiendes
 * un audio y dónde preguntar. Las de compra (precio, plazas) no van aquí:
 * quien lee esto ya está dentro.
 */
